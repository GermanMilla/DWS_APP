...
class IncomeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/incomes')->with('message', 'Nuevo Ingreso Añadido');
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect('/incomes')->with('message', 'Ingreso actualizado exitosamente');
    }

    public function destroy($id)
    {
        Income::findOrFail($id)->delete();
        return back()->with('message', 'Ingreso borrado exitosamente');
    }
}
